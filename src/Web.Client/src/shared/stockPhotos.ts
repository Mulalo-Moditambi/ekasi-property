/**
 * Curated stock photography (Unsplash CDN, hotlink-friendly) used where
 * listings can't supply imagery yet — hero collage fallback and the owner CTA band.
 * These are fresh, vibrant township/informal housing contexts that resonate with
