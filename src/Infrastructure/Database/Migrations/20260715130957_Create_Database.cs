        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Township = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    WaterIncluded = table.Column<bool>(type: "bit", nullable: false),
                    HasOwnEntrance = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_Address_Township",
                schema: "dbo",
                table: "Properties",
                column: "Address_Township");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_Status_ListingType_PropertyType",
                schema: "dbo",
                table: "Properties",
                columns: new[] { "Status", "ListingType", "PropertyType" });
